...
public class easyLevels implements ActionListener {
    ...
    private void openGameWindow() {
        ...
        Image image1 = imageIcon1.getImage().getScaledInstance(200, 400, Image.SCALE_SMOOTH);
        Image image2 = imageIcon2.getImage().getScaledInstance(200, 400, Image.SCALE_SMOOTH);
        Image image3 = imageIcon3.getImage().getScaledInstance(200, 400, Image.SCALE_SMOOTH);
        Image image4 = imageIcon4.getImage().getScaledInstance(200, 400, Image.SCALE_SMOOTH);
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (!Character.isLetter(inputChar) || textField.getText().length() >= 1) {
            ...
            e.consume(); // Consume the space key event
